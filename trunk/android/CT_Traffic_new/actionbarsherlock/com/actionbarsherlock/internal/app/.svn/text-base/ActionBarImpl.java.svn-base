...
public class ActionBarImpl extends ActionBar {
    ...
    private void init(View decor) {
        ...
        mActionView = (ActionBarView) decor.findViewById(ResUtil.getInstance(mContext).getId("abs__action_bar")/* CT_Traffic_R.id.abs__action_bar()*/);
        mContextView = (ActionBarContextView) decor.findViewById(
        		ResUtil.getInstance(mContext).getId("abs__action_context_bar")/*CT_Traffic_R.id.abs__action_context_bar()*/);
        mContainerView = (ActionBarContainer) decor.findViewById(
        		ResUtil.getInstance(mContext).getId("abs__action_bar_container")/*CT_Traffic_R.id.abs__action_bar_container()*/);
        mSplitView = (ActionBarContainer) decor.findViewById(
        		ResUtil.getInstance(mContext).getId("abs__split_action_bar")/*CT_Traffic_R.id.abs__split_action_bar()*/);
        ...
        setHasEmbeddedTabs(getResources_getBoolean(mContext,
        		ResUtil.getInstance(mContext).getBool("abs__action_bar_embed_tabs")/* CT_Traffic_R.bool.abs__action_bar_embed_tabs()*/));
    }
    ...
    public Context getThemedContext() {
        if (mThemedContext == null) {
            ...
            currentTheme.resolveAttribute(ResUtil.getInstance(mContext).getAttr("actionBarWidgetTheme")/* CT_Traffic_R.attr.actionBarWidgetTheme()*/,
                    outValue, true);
