...
public class ActionBarView extends AbsActionBarView {
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, ResUtil.getInstance(context).getStyleable("SherlockActionBar", false)/*CT_Traffic_R.styleable.SherlockActionBar()*/,
        		ResUtil.getInstance(context).getAttr("actionBarStyle")/*CT_Traffic_R.attr.actionBarStyle()*/, 0);

        ApplicationInfo appInfo = context.getApplicationInfo();
        PackageManager pm = context.getPackageManager();
        mNavigationMode = a.getInt(ResUtil.getInstance(context).getStyleable("SherlockActionBar_navigationMode")/* CT_Traffic_R.styleable.SherlockActionBar_navigationMode()*/,
                ActionBar.NAVIGATION_MODE_STANDARD);
        mTitle = a.getText(ResUtil.getInstance(context).getStyleable("SherlockActionBar_title")/*CT_Traffic_R.styleable.SherlockActionBar_title()*/);
        mSubtitle = a.getText(ResUtil.getInstance(context).getStyleable("SherlockActionBar_subtitle")/*CT_Traffic_R.styleable.SherlockActionBar_subtitle()*/);

        mLogo = a.getDrawable(ResUtil.getInstance(context).getStyleable("SherlockActionBar_logo")/*CT_Traffic_R.styleable.SherlockActionBar_logo()*/);
        if (mLogo == null) {
        ...
        mIcon = a.getDrawable(ResUtil.getInstance(context).getStyleable("SherlockActionBar_icon")/*CT_Traffic_R.styleable.SherlockActionBar_icon()*/);
        if (mIcon == null) {
            if (context instanceof Activity) {
                try {
        ...
        final int homeResId = a.getResourceId(
        		ResUtil.getInstance(context).getStyleable("SherlockActionBar_homeLayout")/*CT_Traffic_R.styleable.SherlockActionBar_homeLayout()*/,
        		ResUtil.getInstance(context).getLayout("abs__action_bar_home")/* CT_Traffic_R.layout.abs__action_bar_home()*/);
        ...
        mExpandedHomeLayout.setContentDescription(getResources().getText(
        		ResUtil.getInstance(context).getString("abs__action_bar_up_description")/*CT_Traffic_R.string.abs__action_bar_up_description()*/));

        mTitleStyleRes = a.getResourceId(ResUtil.getInstance(context).getStyleable("SherlockActionBar_titleTextStyle")/*CT_Traffic_R.styleable.SherlockActionBar_titleTextStyle()*/, 0);
        mSubtitleStyleRes = a.getResourceId(ResUtil.getInstance(context).getStyleable("SherlockActionBar_subtitleTextStyle")/*CT_Traffic_R.styleable.SherlockActionBar_subtitleTextStyle()*/, 0);
        mProgressStyle = a.getResourceId(ResUtil.getInstance(context).getStyleable("SherlockActionBar_progressBarStyle")/*CT_Traffic_R.styleable.SherlockActionBar_progressBarStyle()*/, 0);
        mIndeterminateProgressStyle = a.getResourceId(
        		ResUtil.getInstance(context).getStyleable("SherlockActionBar_indeterminateProgressStyle")/*CT_Traffic_R.styleable.SherlockActionBar_indeterminateProgressStyle()*/, 0);

        mProgressBarPadding = a.getDimensionPixelOffset(ResUtil.getInstance(context).getStyleable("SherlockActionBar_progressBarPadding")/*CT_Traffic_R.styleable.SherlockActionBar_progressBarPadding()*/, 0);
        mItemPadding = a.getDimensionPixelOffset(ResUtil.getInstance(context).getStyleable("SherlockActionBar_itemPadding")/*CT_Traffic_R.styleable.SherlockActionBar_itemPadding()*/, 0);

        setDisplayOptions(a.getInt(ResUtil.getInstance(context).getStyleable("SherlockActionBar_displayOptions")/*CT_Traffic_R.styleable.SherlockActionBar_displayOptions()*/, DISPLAY_DEFAULT));

        final int customNavId = a.getResourceId(ResUtil.getInstance(context).getStyleable("SherlockActionBar_customNavigationLayout")/*CT_Traffic_R.styleable.SherlockActionBar_customNavigationLayout()*/, 0);
        if (customNavId != 0) {
        ...
        mContentHeight = a.getLayoutDimension(ResUtil.getInstance(context).getStyleable("SherlockActionBar_height")/*CT_Traffic_R.styleable.SherlockActionBar_height()*/, 0);
    ...
    public void initProgress() {
        ...
        mProgressView.setId(ResUtil.getInstance(mContext).getId("abs__progress_horizontal")/* CT_Traffic_R.id.abs__progress_horizontal()*/);
    ...
    public void initIndeterminateProgress() {
        ...
        mIndeterminateProgressView.setId(ResUtil.getInstance(mContext).getId("abs__progress_circular")/*CT_Traffic_R.id.abs__progress_circular()*/);
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback cb) {
        ...
        if (mActionMenuPresenter == null) {
            ...
            mActionMenuPresenter.setId(ResUtil.getInstance(mContext).getId("abs__action_menu_presenter")/*CT_Traffic_R.id.abs__action_menu_presenter()*/);
        ...
        if (!mSplitActionBar) {
            mActionMenuPresenter.setExpandedActionViewsExclusive(
                    getResources_getBoolean(getContext(),
                    		ResUtil.getInstance(mContext).getBool("abs__action_bar_expanded_action_views_exclusive")/* CT_Traffic_R.bool.abs__action_bar_expanded_action_views_exclusive()*/));
    ...
    public void setHomeButtonEnabled(boolean enable) {
        ...
        if (!enable) {
            ...
            mHomeLayout.setContentDescription(mContext.getResources().getText(
                    ResUtil.getInstance(mContext).getString("abs__action_bar_up_description")/*CT_Traffic_R.string.abs__action_bar_up_description()*/));
        } else {
            mHomeLayout.setContentDescription(mContext.getResources().getText(
            		ResUtil.getInstance(mContext).getString("abs__action_bar_home_description")/*CT_Traffic_R.string.abs__action_bar_home_description()*/));
        }
    }
            ...
            case ActionBar.NAVIGATION_MODE_LIST:
                if (mSpinner == null) {
                    mSpinner = new IcsSpinner(mContext, null,
                    		ResUtil.getInstance(mContext).getAttr("actionDropDownStyle")/*CT_Traffic_R.attr.actionDropDownStyle()*/);
                    mListNavLayout = (IcsLinearLayout) LayoutInflater.from(mContext)
                            .inflate(ResUtil.getInstance(mContext).getLayout("abs__action_bar_tab_bar_view")/* CT_Traffic_R.layout.abs__action_bar_tab_bar_view()*/, null);
    ...
    private void initTitle() {
        if (mTitleLayout == null) {
            ...
            mTitleLayout = (LinearLayout) inflater.inflate(ResUtil.getInstance(mContext).getLayout("abs__action_bar_title_item")/* CT_Traffic_R.layout.abs__action_bar_title_item()*/,
                    this, false);
            mTitleView = (TextView) mTitleLayout.findViewById(ResUtil.getInstance(mContext).getId("abs__action_bar_title")/* CT_Traffic_R.id.abs__action_bar_title()*/);
            mSubtitleView = (TextView) mTitleLayout.findViewById(ResUtil.getInstance(mContext).getId("abs__action_bar_subtitle")/*CT_Traffic_R.id.abs__action_bar_subtitle()*/);
            mTitleUpView = mTitleLayout.findViewById(ResUtil.getInstance(mContext).getId("abs__up")/*CT_Traffic_R.id.abs__up()*/);
    ...
    public static class HomeView extends FrameLayout {
        ...
        @Override
        protected void onFinishInflate() {
            mUpView = findViewById(ResUtil.getInstance(getContext()).getId("abs__up")/*CT_Traffic_R.id.abs__up()*/);
            mIconView = (ImageView) findViewById(ResUtil.getInstance(getContext()).getId("abs__home")/*CT_Traffic_R.id.abs__home()*/);
        }
