...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    */
    ...
    public SearchView(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(ResUtil.getInstance(context).getLayout("abs__search_view")/*CT_Traffic_R.layout.abs__search_view()*/, this, true);

        mSearchButton = findViewById(ResUtil.getInstance(context).getId("abs__search_button")/* CT_Traffic_R.id.abs__search_button()*/);
        mQueryTextView = (SearchAutoComplete) findViewById(ResUtil.getInstance(context).getId("abs__search_src_text")/*CT_Traffic_R.id.abs__search_src_text()*/);
        mQueryTextView.setSearchView(this);

        mSearchEditFrame = findViewById(ResUtil.getInstance(context).getId("abs__search_edit_frame")/*CT_Traffic_R.id.abs__search_edit_frame()*/);
        mSearchPlate = findViewById(ResUtil.getInstance(context).getId("abs__search_plate")/*CT_Traffic_R.id.abs__search_plate()*/);
        mSubmitArea = findViewById(ResUtil.getInstance(context).getId("abs__submit_area")/*CT_Traffic_R.id.abs__submit_area()*/);
        mSubmitButton = findViewById(ResUtil.getInstance(context).getId("abs__search_go_btn")/*CT_Traffic_R.id.abs__search_go_btn()*/);
        mCloseButton = (ImageView) findViewById(ResUtil.getInstance(context).getId("abs__search_close_btn")/*CT_Traffic_R.id.abs__search_close_btn()*/);
        mVoiceButton = findViewById(ResUtil.getInstance(context).getId("abs__search_voice_btn")/*CT_Traffic_R.id.abs__search_voice_btn()*/);
        mSearchHintIcon = (ImageView) findViewById(ResUtil.getInstance(context).getId("abs__search_mag_icon")/*CT_Traffic_R.id.abs__search_mag_icon()*/);
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, ResUtil.getInstance(context).getStyleable("SherlockSearchView", false)/*CT_Traffic_R.styleable.SherlockSearchView()*/, 0, 0);
        setIconifiedByDefault(a.getBoolean(ResUtil.getInstance(context).getStyleable("SherlockSearchView_iconifiedByDefault")/* CT_Traffic_R.styleable.SherlockSearchView_iconifiedByDefault()*/, true));
        int maxWidth = a.getDimensionPixelSize(ResUtil.getInstance(context).getStyleable("SherlockSearchView_android_maxWidth")/*CT_Traffic_R.styleable.SherlockSearchView_android_maxWidth()*/, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        CharSequence queryHint = a.getText(ResUtil.getInstance(context).getStyleable("SherlockSearchView_queryHint")/*CT_Traffic_R.styleable.SherlockSearchView_queryHint()*/);
        if (!TextUtils.isEmpty(queryHint)) {
            setQueryHint(queryHint);
        }
        int imeOptions = a.getInt(ResUtil.getInstance(context).getStyleable("SherlockSearchView_android_imeOptions")/*CT_Traffic_R.styleable.SherlockSearchView_android_imeOptions()*/, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(ResUtil.getInstance(context).getStyleable("SherlockSearchView_android_inputType")/*CT_Traffic_R.styleable.SherlockSearchView_android_inputType()*/, -1);
        if (inputType != -1) {
        ...
        a = context.obtainStyledAttributes(attrs, ResUtil.getInstance(context).getStyleable("SherlockView", false)/*CT_Traffic_R.styleable.SherlockView()*/, 0, 0);
        focusable = a.getBoolean(ResUtil.getInstance(context).getStyleable("SherlockView_android_focusable")/*CT_Traffic_R.styleable.SherlockView_android_focusable()*/, focusable);
        a.recycle();
    ...
    private int getPreferredWidth() {
        return getContext().getResources()
                .getDimensionPixelSize(ResUtil.getInstance(getContext()).getDimen("abs__search_view_preferred_width")/* CT_Traffic_R.dimen.abs__search_view_preferred_width()*/);
    }
    ...
    private int getSearchIconId() {
        ...
        getContext().getTheme().resolveAttribute(ResUtil.getInstance(getContext()).getAttr("searchViewSearchIcon")/*CT_Traffic_R.attr.searchViewSearchIcon()*/,
                outValue, true);
    ...
    private void adjustDropDownSizeAndPosition() {
        if (mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = mIconifiedByDefault
                    ? res.getDimensionPixelSize(ResUtil.getInstance(getContext()).getDimen("abs__dropdownitem_icon_width")/*CT_Traffic_R.dimen.abs__dropdownitem_icon_width()*/)
                    + res.getDimensionPixelSize(ResUtil.getInstance(getContext()).getDimen("abs__dropdownitem_text_padding_left")/*CT_Traffic_R.dimen.abs__dropdownitem_text_padding_left()*/)
                    : 0;
