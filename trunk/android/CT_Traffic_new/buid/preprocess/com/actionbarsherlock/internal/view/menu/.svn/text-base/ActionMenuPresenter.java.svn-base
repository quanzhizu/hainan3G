...
public class ActionMenuPresenter extends BaseMenuPresenter
    ...
    public ActionMenuPresenter(Context context) {
        super(context, CT_Traffic_R.layout.abs__action_menu_layout(),
        		CT_Traffic_R.layout.abs__action_menu_item_layout());
    }
    ...
    public void initForMenu(Context context, MenuBuilder menu) {
        ...
        if (!mMaxItemsSet) {
            mMaxItems = getResources_getInteger(context, CT_Traffic_R.integer.abs__max_action_buttons());
        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (!mMaxItemsSet) {
            mMaxItems = getResources_getInteger(mContext,
            		CT_Traffic_R.integer.abs__max_action_buttons());
            if (mMenu != null) {
    ...
    private class OverflowMenuButton extends ImageButton implements ActionMenuChildView, View_HasStateListenerSupport {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, CT_Traffic_R.attr.actionOverflowButtonStyle());
