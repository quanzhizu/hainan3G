...
public class HotspotGridAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			vh = new ViewHolder();
			convertView = mInflater.inflate(R.layout.hotspot_grid_item, null);
			vh.ivHotspot = (ImageView) convertView.findViewById(R.id.hotspot_grid_item_iv_hotspot);
			vh.tvHotspot = (TextView) convertView.findViewById(R.id.hotspot_grid_item_tv_hotspot);
