...
public class ActionBarContainer extends NineFrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                CT_Traffic_R.styleable.SherlockActionBar());
        mBackground = a.getDrawable(CT_Traffic_R.styleable.SherlockActionBar_background());
        mStackedBackground = a.getDrawable(
        		CT_Traffic_R.styleable.SherlockActionBar_backgroundStacked());
        ...
        if (getId() == CT_Traffic_R.id.abs__split_action_bar()) {
            mIsSplit = true;
            mSplitBackground = a.getDrawable(
            		CT_Traffic_R.styleable.SherlockActionBar_backgroundSplit());
        }
        a.recycle();
    ...
    public void onFinishInflate() {
        ...
        mActionBarView = (ActionBarView) findViewById(CT_Traffic_R.id.abs__action_bar());
    }
