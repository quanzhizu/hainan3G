...
public class IcsSpinner extends IcsAbsSpinner implements OnClickListener {
    ...
    public IcsSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, ResUtil.getInstance(context).getAttr("actionDropDownStyle")/*CT_Traffic_R.attr.actionDropDownStyle()*/);
    }
    ...
    public IcsSpinner(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
        		ResUtil.getInstance(context).getStyleable("SherlockSpinner", false)/* CT_Traffic_R.styleable.SherlockSpinner()*/, defStyle, 0);


        DropdownPopup popup = new DropdownPopup(context, attrs, defStyle);

        mDropDownWidth = a.getLayoutDimension(
        		ResUtil.getInstance(context).getStyleable("SherlockSpinner_android_dropDownWidth")/*CT_Traffic_R.styleable.SherlockSpinner_android_dropDownWidth()*/,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        popup.setBackgroundDrawable(a.getDrawable(
        		ResUtil.getInstance(context).getStyleable("SherlockSpinner_android_popupBackground")/*CT_Traffic_R.styleable.SherlockSpinner_android_popupBackground()*/));
        final int verticalOffset = a.getDimensionPixelOffset(
        		ResUtil.getInstance(context).getStyleable("SherlockSpinner_android_dropDownVerticalOffset")/*CT_Traffic_R.styleable.SherlockSpinner_android_dropDownVerticalOffset()*/, 0);
        if (verticalOffset != 0) {
            popup.setVerticalOffset(verticalOffset);
        }

        final int horizontalOffset = a.getDimensionPixelOffset(
        		ResUtil.getInstance(context).getStyleable("SherlockSpinner_android_dropDownHorizontalOffset")/*CT_Traffic_R.styleable.SherlockSpinner_android_dropDownHorizontalOffset()*/, 0);
        ...
        mGravity = a.getInt(ResUtil.getInstance(context).getStyleable("SherlockSpinner_android_gravity")/*CT_Traffic_R.styleable.SherlockSpinner_android_gravity()*/, Gravity.CENTER);

        mPopup.setPromptText(a.getString(ResUtil.getInstance(context).getStyleable("SherlockSpinner_android_prompt")/*CT_Traffic_R.styleable.SherlockSpinner_android_prompt()*/));
