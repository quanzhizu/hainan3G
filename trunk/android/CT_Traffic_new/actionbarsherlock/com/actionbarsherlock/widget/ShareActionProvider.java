...
public class ShareActionProvider extends ActionProvider {
    ...
    public View onCreateActionView() {
        ...
        mContext.getTheme().resolveAttribute(ResUtil.getInstance(mContext).getAttr("actionModeShareDrawable")/*CT_Traffic_R.attr.actionModeShareDrawable()*/, outTypedValue, true);
        ...
        activityChooserView.setDefaultActionButtonContentDescription(
        		ResUtil.getInstance(mContext).getString("abs__shareactionprovider_share_with_application")/*CT_Traffic_R.string.abs__shareactionprovider_share_with_application()*/);
        activityChooserView.setExpandActivityOverflowButtonContentDescription(
        		ResUtil.getInstance(mContext).getString("abs__shareactionprovider_share_with")/*CT_Traffic_R.string.abs__shareactionprovider_share_with()*/);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (collapsedActivityCount < expandedActivityCount) {
            ...
            SubMenu expandedSubMenu = subMenu.addSubMenu(Menu.NONE, collapsedActivityCount,
                    ...
                    mContext.getString(ResUtil.getInstance(mContext).getString("abs__activity_chooser_view_see_all")/*CT_Traffic_R.string.abs__activity_chooser_view_see_all()*/));
