...
public class ActionOptionsAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(activity).inflate(ResUtil.getInstance(activity).getLayout("ct_traffic__action_option_item"), null);
			holder.textView = (TextView) convertView.findViewById(ResUtil.getInstance(activity).getId("item_text"));
