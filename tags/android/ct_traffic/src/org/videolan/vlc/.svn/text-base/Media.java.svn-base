...
public class Media implements Comparable<Media> {
    ...
    public Media(String URI, Boolean addToDb) {
        ...
        if (addToDb) {
            ...
            DatabaseManager db = DatabaseManager.getInstance(TrafficApplication.getAppContext());
            db.addMedia(this);
        }
    }
    ...
    public Bitmap getPicture() {
        ...
        if (mPicture == null) {
            ...
            if (picture == null) {
                 ...
                 */
                Context c = TrafficApplication.getAppContext();
    ...
    public String getGenre() {
        if(mGenre == TrafficApplication.getAppContext().getString(R.string.unknown_genre))
            return mGenre;
