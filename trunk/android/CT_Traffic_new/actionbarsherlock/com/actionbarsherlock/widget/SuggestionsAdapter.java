...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    public SuggestionsAdapter(Context context, SearchView searchView,
        ...
        super(context,
        		ResUtil.getInstance(context).getLayout("abs__search_dropdown_item_icons_2line")/*CT_Traffic_R.layout.abs__search_dropdown_item_icons_2line()*/,
...
//    });
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        v.setTag(new ChildViewCache(v,context));
        return v;
    }
    ...
    private final static class ChildViewCache {
        ...
        public ChildViewCache(View v,Context context) {
            ...
            mIconRefine = (ImageView) v.findViewById(ResUtil.getInstance(context).getId("edit_query")/* CT_Traffic_R.id.edit_query()*/);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (mUrlColor == null) {
            ...
            mContext.getTheme().resolveAttribute(ResUtil.getInstance(mContext).getAttr("textColorSearchUrl")/* CT_Traffic_R.attr.textColorSearchUrl()*/, colorValue, true);
