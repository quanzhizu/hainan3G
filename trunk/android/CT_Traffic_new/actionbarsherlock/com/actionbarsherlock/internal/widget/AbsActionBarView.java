...
public abstract class AbsActionBarView extends NineViewGroup {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, ResUtil.getInstance(mContext).getStyleable("SherlockActionBar", false)/* CT_Traffic_R.styleable.SherlockActionBar()*/,
                ResUtil.getInstance(mContext).getAttr("actionBarStyle")/*CT_Traffic_R.attr.actionBarStyle()*/, 0);
        setContentHeight(a.getLayoutDimension(ResUtil.getInstance(mContext).getStyleable("SherlockActionBar_height")/*CT_Traffic_R.styleable.SherlockActionBar_height()*/, 0));
        a.recycle();
        if (mSplitWhenNarrow) {
            setSplitActionBar(getResources_getBoolean(getContext(),
                    ResUtil.getInstance(mContext).getBool("abs__split_action_bar_is_narrow")/* CT_Traffic_R.bool.abs__split_action_bar_is_narrow()*/));
        }
