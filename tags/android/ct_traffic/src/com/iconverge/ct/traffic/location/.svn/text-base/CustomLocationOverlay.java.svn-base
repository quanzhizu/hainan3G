...
//					context.startActivity(intent);
		...
		protected LayoutParams getLayoutParam(int arg0) {
			// TODO Auto-generated method stub
			LayoutParams 
				 params=new MapView.LayoutParams(MapView.LayoutParams.WRAP_CONTENT,MapView.LayoutParams.WRAP_CONTENT,poiItems.get(number).getPoint(),0,-height,LayoutParams.BOTTOM_CENTER);
