...
public class MenuPopupHelper implements AdapterView.OnItemClickListener, View.OnKeyListener,
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu,
        ...
        mContext = context;
        ITEM_LAYOUT = ResUtil.getInstance(mContext).getLayout("abs__popup_menu_item_layout")/*CT_Traffic_R.layout.abs__popup_menu_item_layout()*/;
        ...
        mPopupMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2,
                res.getDimensionPixelSize(ResUtil.getInstance(mContext).getDimen("abs__config_prefDialogWidth")/* CT_Traffic_R.dimen.abs__config_prefDialogWidth()*/));
    ...
    public boolean tryShow() {
        mPopup = new IcsListPopupWindow(mContext, null, ResUtil.getInstance(mContext).getAttr("popupMenuStyle")/*CT_Traffic_R.attr.popupMenuStyle()*/);
