 ...
 * 自定义timeout时间等参数
 */
public class BVBHttpClient {
	
	private static final String TAG = "BVBHttpClient";
	...
	public static HttpClient getNewInstance(Context mContext) {
		...
		case TYPE_CM_CU_WAP: {
			...
			newInstance.getParams().setParameter(ConnRoutePNames.DEFAULT_PROXY,
					proxy);
			Log.i(TAG, "cmcc cu wap proxy 10.0.0.172");
		}
			break;
		}
		return newInstance;
