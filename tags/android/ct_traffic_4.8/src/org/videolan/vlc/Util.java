...
public class Util {
	...
	public static String readAsset(String assetName, String defaultS) {
		try {
			InputStream is = TrafficApplication.getAppResources().getAssets().open(assetName);
	...
	public static String getValue(String string, int defaultId) {
		return (string != null && string.length() > 0) ? string : TrafficApplication.getAppContext().getString(defaultId);
	}

	public static int convertPxToDp(int px) {
		WindowManager wm = (WindowManager) TrafficApplication.getAppContext().getSystemService(Context.WINDOW_SERVICE);
	...
	public static int convertDpToPx(int dp) {
		return Math.round(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp, TrafficApplication.getAppResources().getDisplayMetrics()));
	}
	...
	public static boolean hasCompatibleCPU() {
		...
		boolean hasNeon = false, hasFpu = false, hasArmV6 = false, hasArmV7 = false, hasMips = false;
	...
	public static boolean isPhone() {
		TelephonyManager manager = (TelephonyManager) TrafficApplication.getAppContext().getSystemService(Context.TELEPHONY_SERVICE);
	...
	public static String[] getCustomDirectories() {
		SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(TrafficApplication.getAppContext());
