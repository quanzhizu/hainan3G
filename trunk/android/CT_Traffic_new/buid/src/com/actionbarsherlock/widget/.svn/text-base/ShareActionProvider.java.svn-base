...
public class ShareActionProvider extends ActionProvider {
    ...
    public View onCreateActionView() {
        ...
        mContext.getTheme().resolveAttribute(CT_Traffic_R.attr.actionModeShareDrawable(), outTypedValue, true);
        ...
        activityChooserView.setDefaultActionButtonContentDescription(
        		CT_Traffic_R.string.abs__shareactionprovider_share_with_application());
        activityChooserView.setExpandActivityOverflowButtonContentDescription(
        		CT_Traffic_R.string.abs__shareactionprovider_share_with());
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (collapsedActivityCount < expandedActivityCount) {
            ...
            SubMenu expandedSubMenu = subMenu.addSubMenu(Menu.NONE, collapsedActivityCount,
                    ...
                    mContext.getString(CT_Traffic_R.string.abs__activity_chooser_view_see_all()));
