...
public class ActionBarContainer extends NineFrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                ResUtil.getInstance(context).getStyleable("SherlockActionBar", false)/*CT_Traffic_R.styleable.SherlockActionBar()*/);
        mBackground = a.getDrawable(ResUtil.getInstance(context).getStyleable("SherlockActionBar_background")/* CT_Traffic_R.styleable.SherlockActionBar_background()*/);
        mStackedBackground = a.getDrawable(
        		ResUtil.getInstance(context).getStyleable("SherlockActionBar_backgroundStacked")/*CT_Traffic_R.styleable.SherlockActionBar_backgroundStacked()*/);
        ...
        if (getId() == ResUtil.getInstance(context).getId("abs__split_action_bar")/*CT_Traffic_R.id.abs__split_action_bar()*/) {
            mIsSplit = true;
            mSplitBackground = a.getDrawable(
            		ResUtil.getInstance(context).getStyleable("SherlockActionBar_backgroundSplit")/* CT_Traffic_R.styleable.SherlockActionBar_backgroundSplit()*/);
        }
        a.recycle();
    ...
    public void onFinishInflate() {
        ...
        mActionBarView = (ActionBarView) findViewById(ResUtil.getInstance(getContext()).getId("abs__action_bar")/* CT_Traffic_R.id.abs__action_bar()*/);
    }
