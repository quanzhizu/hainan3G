...
public class ScrollingTabContainerView extends NineHorizontalScrollView
    ...
    public ScrollingTabContainerView(Context context) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, ResUtil.getInstance(context).getStyleable("SherlockActionBar", false)/*CT_Traffic_R.styleable.SherlockActionBar()*/,
        		ResUtil.getInstance(context).getAttr("actionBarStyle")/* CT_Traffic_R.attr.actionBarStyle()*/, 0);
        setContentHeight(a.getLayoutDimension(ResUtil.getInstance(context).getStyleable("SherlockActionBar_height")/* CT_Traffic_R.styleable.SherlockActionBar_height()*/, 0));
        a.recycle();
    ...
    private IcsLinearLayout createTabLayout() {
        final IcsLinearLayout tabLayout = (IcsLinearLayout) LayoutInflater.from(getContext())
                .inflate(ResUtil.getInstance(getContext()).getLayout("abs__action_bar_tab_bar_view")/* CT_Traffic_R.layout.abs__action_bar_tab_bar_view()*/, null);
    ...
    private IcsSpinner createSpinner() {
        final IcsSpinner spinner = new IcsSpinner(getContext(), null,
        		ResUtil.getInstance(getContext()).getAttr("actionDropDownStyle")/*CT_Traffic_R.attr.actionDropDownStyle()*/);
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, ResUtil.getInstance(getContext()).getStyleable("SherlockActionBar", false)/*CT_Traffic_R.styleable.SherlockActionBar()*/,
        		ResUtil.getInstance(getContext()).getAttr("actionBarStyle")/*CT_Traffic_R.attr.actionBarStyle()*/, 0);
        setContentHeight(a.getLayoutDimension(ResUtil.getInstance(getContext()).getStyleable("SherlockActionBar_height")/* CT_Traffic_R.styleable.SherlockActionBar_height()*/, 0));
        a.recycle();
    }
    ...
    private TabView createTabView(ActionBar.Tab tab, boolean forAdapter) {
        ...
        final TabView tabView = (TabView)mInflater.inflate(ResUtil.getInstance(getContext()).getLayout("abs__action_bar_tab")/* CT_Traffic_R.layout.abs__action_bar_tab()*/, null);
                ...
                if (text != null) {
                    if (mTextView == null) {
                        CapitalizingTextView textView = new CapitalizingTextView(getContext(), null,
                        		ResUtil.getInstance(getContext()).getAttr("actionBarTabTextStyle")/*CT_Traffic_R.attr.actionBarTabTextStyle()*/);
