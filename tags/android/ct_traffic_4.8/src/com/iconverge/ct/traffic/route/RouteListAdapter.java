...
public class RouteListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(activity).inflate(R.layout.route_list_item, null);
			...
			holder.textViewDescription = (TextView) convertView.findViewById(R.id.item_text_description);
			holder.textViewTime = (TextView) convertView.findViewById(R.id.item_text_time);
		...
		builder.append(MessageFormat.format(activity.getString(R.string.need_time), segment.getConsumeTime()));
