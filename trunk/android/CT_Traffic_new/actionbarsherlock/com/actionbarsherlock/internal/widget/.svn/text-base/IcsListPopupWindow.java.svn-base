...
public class IcsListPopupWindow {
    ...
    public IcsListPopupWindow(Context context) {
        this(context, null, ResUtil.getInstance(context).getAttr("listPopupWindowStyle")/*CT_Traffic_R.attr.listPopupWindowStyle()*/);
    }
    ...
    private static class DropDownListView extends ListView {
        ...
        public DropDownListView(Context context, boolean hijackFocus) {
            super(context, null, /*com.android.internal.*/ResUtil.getInstance(context).getAttr("dropDownListViewStyle")/*CT_Traffic_R.attr.dropDownListViewStyle()*/);
