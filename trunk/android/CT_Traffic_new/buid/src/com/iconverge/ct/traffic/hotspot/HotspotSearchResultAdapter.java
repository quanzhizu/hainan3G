...
public class HotspotSearchResultAdapter extends BaseAdapter {

	private Context mContext;
	private LayoutInflater mInflater;
	private List<PoiItem> result;
	Drawable drawable;
	public HotspotSearchResultAdapter(Context context) {
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//Log.i("PoiItem", " Title:" + item.getTitle() + " PoiId:" + item.getPoiId() + "\n Snippet:" + item.getSnippet() + " AdCode:" + item.getAdCode() + " Distance:" + item.getDistance() + "\n Tel:" + item.getTel() + " TypeCode:" + item.getTypeCode() + " TypeDes:" + item.getTypeDes() + "\n Point:" + item.getPoint().toString());
		return convertView;
	}
