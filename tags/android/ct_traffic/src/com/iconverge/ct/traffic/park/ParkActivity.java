...
public class ParkActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		// #debug debug
		System.out.println("ParkActivity == onCreate");
		...
		listView = (ListView) findViewById(R.id.park_lv_parks);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View parent, int position, long arg3) {
				...
				PoiItem poiItem = new PoiItem(PoiTypeDef.PublicService, geoPoint, park.getName(), park.getAddress());
				poiItems[0] = poiItem;
