...
public class ActionMenuItemView extends LinearLayout
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mAllowTextWithIcon = getResources_getBoolean(context,
                ResUtil.getInstance(context).getBool("abs__config_allowActionMenuItemTextWithIcon")/* CT_Traffic_R.bool.abs__config_allowActionMenuItemTextWithIcon()*/);
        TypedArray a = context.obtainStyledAttributes(attrs,
        		ResUtil.getInstance(context).getStyleable("SherlockActionMenuItemView", false)/* CT_Traffic_R.styleable.SherlockActionMenuItemView()*/, 0, 0);
        mMinWidth = a.getDimensionPixelSize(
        		ResUtil.getInstance(context).getStyleable("SherlockActionMenuItemView_android_minWidth")/*CT_Traffic_R.styleable.SherlockActionMenuItemView_android_minWidth()*/, 0);
        a.recycle();
    }
    ...
    public void onFinishInflate() {
        ...
        mImageButton = (ImageButton) findViewById(ResUtil.getInstance(getContext()).getId("abs__imageButton")/* CT_Traffic_R.id.abs__imageButton()*/);
        mTextButton = (CapitalizingButton) findViewById(ResUtil.getInstance(getContext()).getId("abs__textButton")/*CT_Traffic_R.id.abs__textButton()*/);
