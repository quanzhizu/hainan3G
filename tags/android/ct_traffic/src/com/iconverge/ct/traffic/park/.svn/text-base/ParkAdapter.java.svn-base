...
public class ParkAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			vh = new ViewHolder();
			convertView = mInflater.inflate(R.layout.park_item, null);
			vh.tvName = (TextView) convertView.findViewById(R.id.park_item_tv_name);
			vh.tvStatus = (TextView) convertView.findViewById(R.id.park_item_tv_status);
			vh.tvRemainderTotal = (TextView) convertView.findViewById(R.id.park_item_tv_remainder_total);
			vh.tvAddress = (TextView) convertView.findViewById(R.id.park_item_tv_address);
			vh.tvTime = (TextView) convertView.findViewById(R.id.park_item_tv_time);
		...
		vh.tvStatus.setText("1".equals(park.getStatus())?mContext.getString(R.string.car_park_open):mContext.getString(R.string.car_park_stop));
