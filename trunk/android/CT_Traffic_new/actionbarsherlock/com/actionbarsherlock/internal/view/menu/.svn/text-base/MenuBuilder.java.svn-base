    ...
    private void setShortcutsVisibleInner(boolean shortcutsVisible) {
        mShortcutsVisible = shortcutsVisible
                ...
                && mResources.getBoolean(
                        ResUtil.getInstance(mContext).getBool("abs__config_showMenuShortcutsWhenKeyboardPresent")/* CT_Traffic_R.bool.abs__config_showMenuShortcutsWhenKeyboardPresent()*/);
    }
