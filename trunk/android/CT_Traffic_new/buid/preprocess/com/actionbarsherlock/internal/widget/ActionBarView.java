...
public class ActionBarView extends AbsActionBarView {
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, CT_Traffic_R.styleable.SherlockActionBar(),
        		CT_Traffic_R.attr.actionBarStyle(), 0);

        ApplicationInfo appInfo = context.getApplicationInfo();
        PackageManager pm = context.getPackageManager();
        mNavigationMode = a.getInt(CT_Traffic_R.styleable.SherlockActionBar_navigationMode(),
                ActionBar.NAVIGATION_MODE_STANDARD);
        mTitle = a.getText(CT_Traffic_R.styleable.SherlockActionBar_title());
        mSubtitle = a.getText(CT_Traffic_R.styleable.SherlockActionBar_subtitle());

        mLogo = a.getDrawable(CT_Traffic_R.styleable.SherlockActionBar_logo());
        if (mLogo == null) {
        ...
        mIcon = a.getDrawable(CT_Traffic_R.styleable.SherlockActionBar_icon());
        if (mIcon == null) {
            if (context instanceof Activity) {
                try {
        ...
        final int homeResId = a.getResourceId(
        		CT_Traffic_R.styleable.SherlockActionBar_homeLayout(),
        		CT_Traffic_R.layout.abs__action_bar_home());
        ...
        mExpandedHomeLayout.setContentDescription(getResources().getText(
        		CT_Traffic_R.string.abs__action_bar_up_description()));

        mTitleStyleRes = a.getResourceId(CT_Traffic_R.styleable.SherlockActionBar_titleTextStyle(), 0);
        mSubtitleStyleRes = a.getResourceId(CT_Traffic_R.styleable.SherlockActionBar_subtitleTextStyle(), 0);
        mProgressStyle = a.getResourceId(CT_Traffic_R.styleable.SherlockActionBar_progressBarStyle(), 0);
        mIndeterminateProgressStyle = a.getResourceId(
        		CT_Traffic_R.styleable.SherlockActionBar_indeterminateProgressStyle(), 0);

        mProgressBarPadding = a.getDimensionPixelOffset(CT_Traffic_R.styleable.SherlockActionBar_progressBarPadding(), 0);
        mItemPadding = a.getDimensionPixelOffset(CT_Traffic_R.styleable.SherlockActionBar_itemPadding(), 0);

        setDisplayOptions(a.getInt(CT_Traffic_R.styleable.SherlockActionBar_displayOptions(), DISPLAY_DEFAULT));

        final int customNavId = a.getResourceId(CT_Traffic_R.styleable.SherlockActionBar_customNavigationLayout(), 0);
        if (customNavId != 0) {
        ...
        mContentHeight = a.getLayoutDimension(CT_Traffic_R.styleable.SherlockActionBar_height(), 0);
    ...
    public void initProgress() {
        ...
        mProgressView.setId(CT_Traffic_R.id.abs__progress_horizontal());
    ...
    public void initIndeterminateProgress() {
        ...
        mIndeterminateProgressView.setId(CT_Traffic_R.id.abs__progress_circular());
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback cb) {
        ...
        if (mActionMenuPresenter == null) {
            ...
            mActionMenuPresenter.setId(CT_Traffic_R.id.abs__action_menu_presenter());
        ...
        if (!mSplitActionBar) {
            mActionMenuPresenter.setExpandedActionViewsExclusive(
                    getResources_getBoolean(getContext(),
                    		CT_Traffic_R.bool.abs__action_bar_expanded_action_views_exclusive()));
    ...
    public void setHomeButtonEnabled(boolean enable) {
        ...
        if (!enable) {
            ...
            mHomeLayout.setContentDescription(mContext.getResources().getText(
                    CT_Traffic_R.string.abs__action_bar_home_description()));
        }
    }
            ...
            case ActionBar.NAVIGATION_MODE_LIST:
                if (mSpinner == null) {
                    mSpinner = new IcsSpinner(mContext, null,
                    		CT_Traffic_R.attr.actionDropDownStyle());
                    mListNavLayout = (IcsLinearLayout) LayoutInflater.from(mContext)
                            .inflate(CT_Traffic_R.layout.abs__action_bar_tab_bar_view(), null);
    ...
    private void initTitle() {
        if (mTitleLayout == null) {
            ...
            mTitleLayout = (LinearLayout) inflater.inflate(CT_Traffic_R.layout.abs__action_bar_title_item(),
                    this, false);
            mTitleView = (TextView) mTitleLayout.findViewById(CT_Traffic_R.id.abs__action_bar_title());
            mSubtitleView = (TextView) mTitleLayout.findViewById(CT_Traffic_R.id.abs__action_bar_subtitle());
            mTitleUpView = mTitleLayout.findViewById(CT_Traffic_R.id.abs__up());
    ...
    public static class HomeView extends FrameLayout {
        ...
        @Override
        protected void onFinishInflate() {
            mUpView = findViewById(CT_Traffic_R.id.abs__up());
            mIconView = (ImageView) findViewById(CT_Traffic_R.id.abs__home());
        }
