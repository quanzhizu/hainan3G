...
public class HotspotPopupTypesAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(activity).inflate(R.layout.hotspot_popup_types_item, null);
			holder.textView = (TextView) convertView.findViewById(R.id.hotspot_popup_types_item_tv_type);
