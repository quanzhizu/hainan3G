...
public class ActionMenuItemView extends LinearLayout
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mAllowTextWithIcon = getResources_getBoolean(context,
                CT_Traffic_R.bool.abs__config_allowActionMenuItemTextWithIcon());
        TypedArray a = context.obtainStyledAttributes(attrs,
        		CT_Traffic_R.styleable.SherlockActionMenuItemView(), 0, 0);
        mMinWidth = a.getDimensionPixelSize(
        		CT_Traffic_R.styleable.SherlockActionMenuItemView_android_minWidth(), 0);
        a.recycle();
    }
    ...
    public void onFinishInflate() {
        ...
        mImageButton = (ImageButton) findViewById(CT_Traffic_R.id.abs__imageButton());
        mTextButton = (CapitalizingButton) findViewById(CT_Traffic_R.id.abs__textButton());
