...
public class RegionActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		context = this;
		setContentView(ResUtil.getInstance(context).getLayout("ct_traffic__region"));
		...
		listView = (ListView) findViewById(ResUtil.getInstance(context).getId("region_lv_regions"));
