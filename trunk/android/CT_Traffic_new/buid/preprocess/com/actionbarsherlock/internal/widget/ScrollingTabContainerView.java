...
public class ScrollingTabContainerView extends NineHorizontalScrollView
    ...
    public ScrollingTabContainerView(Context context) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, CT_Traffic_R.styleable.SherlockActionBar(),
        		CT_Traffic_R.attr.actionBarStyle(), 0);
        setContentHeight(a.getLayoutDimension(CT_Traffic_R.styleable.SherlockActionBar_height(), 0));
        a.recycle();
    ...
    private TabView createTabView(ActionBar.Tab tab, boolean forAdapter) {
        ...
        final TabView tabView = (TabView)mInflater.inflate(CT_Traffic_R.layout.abs__action_bar_tab(), null);
                ...
                if (text != null) {
                    if (mTextView == null) {
                        CapitalizingTextView textView = new CapitalizingTextView(getContext(), null,
                        		CT_Traffic_R.attr.actionBarTabTextStyle());
