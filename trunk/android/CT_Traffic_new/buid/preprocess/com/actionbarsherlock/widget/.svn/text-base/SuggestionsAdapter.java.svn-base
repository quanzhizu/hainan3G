...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    public SuggestionsAdapter(Context context, SearchView searchView,
        ...
        super(context,
        		CT_Traffic_R.layout.abs__search_dropdown_item_icons_2line(),
...
//    });
    ...
    private final static class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            mIconRefine = (ImageView) v.findViewById(CT_Traffic_R.id.edit_query());
        }
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (mUrlColor == null) {
            ...
            mContext.getTheme().resolveAttribute(CT_Traffic_R.attr.textColorSearchUrl(), colorValue, true);
