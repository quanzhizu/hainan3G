...
public class CustomDialog {
	...
	public final static Dialog confirmDialog(Context context, String title, String message, String positive, View.OnClickListener positiveClick, String neutral, View.OnClickListener neutralClick, String negative, View.OnClickListener negativeClick) {
		...
		View view0 = (View) LayoutInflater.from(context).inflate(R.layout.dialog_yes_no_message, null);
		...
		TextView titleView = (TextView) view0.findViewById(R.id.dialog_title_textview);
		titleView.setText(title == null ? context.getResources().getString(R.string.tips) : title);

		TextView messageText = (TextView) view0.findViewById(R.id.dialog_message_textview);
		...
		Button positiveBtn = (Button) view0.findViewById(R.id.dialog_button_positive);
		if (positive != null) {
		...
		Button neutralBtn = (Button) view0.findViewById(R.id.dialog_button_neutral);
		if (neutral != null) {
		...
		Button negativeBtn = (Button) view0.findViewById(R.id.dialog_button_negative);
		if (negative != null) {
	...
	public final static Dialog createDialog(Context context, String title, View view, String positive, View.OnClickListener positiveClick, String neutral, View.OnClickListener neutralClick, String negative, View.OnClickListener negativeClick) {
		Dialog dialog = new Dialog(context, R.style.dialog_dim);
		View view0 = (View) LayoutInflater.from(context).inflate(R.layout.dialog, null);
		...
		LinearLayout contentView = (LinearLayout) view0.findViewById(R.id.view);
	...
	public final static Dialog listDialog(Context context, String title, String[] items, ListView listView) {
		Dialog dialog = new Dialog(context, R.style.dialog_dim);
		View view0 = (View) LayoutInflater.from(context).inflate(R.layout.dialog_list, null);
		...
		LinearLayout contentView = (LinearLayout) view0.findViewById(R.id.dialog_bg);
		listView.setChoiceMode(ListView.CHOICE_MODE_SINGLE);
		listView.setAddStatesFromChildren(true);
		listView.setCacheColorHint(context.getResources().getColor(R.color.color_list_cache_hint));
		listView.setDividerHeight(0);
		CheckedListAdapter listAdapter = new CheckedListAdapter(context);
		listAdapter.mData = items;
		listView.setAdapter(listAdapter);
		listView.setBackgroundColor(context.getResources().getColor(R.color.color_list_cache_hint));
		listView.setSelector(R.color.color_list_cache_hint);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			if (type == ListView.CHOICE_MODE_SINGLE)
				convertView = LayoutInflater.from(mContext).inflate(R.layout.single_checked_item, null);
			else if (type == ListView.CHOICE_MODE_MULTIPLE)
				convertView = LayoutInflater.from(mContext).inflate(R.layout.multi_checked_item, null);
			else
				convertView = LayoutInflater.from(mContext).inflate(R.layout.none_checked_item, null);
			holder.layout = (LinearLayout) convertView.findViewById(R.id.layout1);
			holder.textView = (CheckedTextView) convertView.findViewById(R.id.text1);
		...
		if (type == 0) {
			if (mData.length == 1) {
				holder.layout.setBackgroundResource(R.drawable.setting_item_bg);
			} else {
				if (position == 0) {
					holder.layout.setBackgroundResource(R.drawable.setting_item_top);
				} else if (position == getCount() - 1) {
					holder.layout.setBackgroundResource(R.drawable.setting_item_bottom);
				} else {
					holder.layout.setBackgroundResource(R.drawable.setting_item_center);
				}
			}
		} else {
			if (mData.length == 1) {
				holder.textView.setBackgroundResource(R.drawable.setting_item_bg);
			} else {
				if (position == 0) {
					holder.textView.setBackgroundResource(R.drawable.setting_item_top);
				} else if (position == getCount() - 1) {
					holder.textView.setBackgroundResource(R.drawable.setting_item_bottom);
				} else {
					holder.textView.setBackgroundResource(R.drawable.setting_item_center);
				}
			}
		}
